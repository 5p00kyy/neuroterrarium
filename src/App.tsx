          ...
          <section className="instrument" aria-label="Terrarium instrument">
            ...
            <div className="transport">
              <button
                ...
                disabled={!ready}
                onClick={() => send({ type: "run", running: !running, speed })}
              >
                {running ? "Ⅱ Pause" : "▶ Run"}
              </button>
              <button
                ...
                {POPULATIONS.map((p, i) => (
                  <div className="region" key={p}>
                    ...
                    <div>
                      <b
                        style={{
                          width: Math.min(100, selected.regions[i] * 300) + "%",
                          background: color,
                        }}
                      />
                    </div>
              ...
              {training ? (
                ...
                >
                  ...
                  <div className="micro">
                    ...
                    MSE
                    <br />
                    Zero-feature ablation: {training.ablatedMSE.toFixed(3)} MSE
                    <br />
          ...
          <article>
            {PROVENANCE.filter((p) => p.id === inspector).map((p) => (
              <div key={p.id}>
                ...
                <p>
                  No real connectome is loaded. A miniature fixture demonstrates
                  engineering semantics, not biological fidelity, consciousness
                  or a topology advantage.
                </p>
              </div>
            ))}
          </article>
